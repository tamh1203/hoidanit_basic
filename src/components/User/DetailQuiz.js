...
const DetailQuiz = (props) => {
    ...
    const handleNext = () => {
        if (dataQuiz && dataQuiz.length > index + 1)
            setIndex(index + 1)
        console.log(index, dataQuiz.length);
    }
    // console.log(index);
    ...
    const handleSubmitFinish = async () => {
        ...
        if (dataQuiz && dataQuiz.length > 0) {
            ...
            if (res && res.EC === 0) {
                ...
                console.log("res.DT.quizData", res.DT.quizData);
                            ...
                            if (+q.questionId === +dataQuizClone[i].questionID) {
                                ...
                                for (let j = 0; dataQuizClone[i].answers.length > j; j++) {
                                    ...
                                    if (s) {
                                        ...
                                        console.log("abc", dataQuizClone[i].answers[j].isCorrect);
                                    }
                ...
                <div className='left-content'>
                    ...
                    <div className='footer'>
                        ...
                        <button
                            ...
                            onClick={() => handleNext()}
                            disabled={dataQuiz.length < index + 2 ? true : false}
                        > Next </button>
                        <button
